...
import type { TransportRouteStatus } from "@/features/transport-route/types/transport-route.types";

const STATUS_STYLES: Record<TransportRouteStatus, string> = {
...
export function TransportRouteStatusBadge({ status }: { status: TransportRouteStatus }) {
  return (
