...
import { useListAllTourBookingsQuery } from "@/features/tour-booking/api/tour-booking.api";
import type { TourBookingStatus } from "@/features/tour-booking/types/tour-booking.types";
...
export default function TourBookingsPage() {
  ...
  const { data, isLoading, isError } = useListAllTourBookingsQuery({ status, limit: 50 });
      ...
      <main className="p-6">
        <div className="rounded-[var(--radius-lg)] border border-border bg-card">
          <div className="flex items-center justify-between gap-4 border-b border-border p-4">
            <p className="font-semibold">Toàn bộ đơn đặt tour</p>
