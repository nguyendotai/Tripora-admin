...
import { useListPromotionsQuery } from "@/features/promotion/api/promotion.api";
...
export default function PromotionsManagementPage() {
  ...
  const { data, isLoading, isError } = useListPromotionsQuery({ limit: 100 });
      ...
      <main className="p-6">
        <div className="rounded-[var(--radius-lg)] border border-border bg-card">
          <div className="flex items-center justify-between border-b border-border p-4">
            <p className="font-semibold">Chương trình khuyến mãi tự động</p>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center gap-1 p-10 text-center">
              ...
              <p className="text-xs text-muted-foreground">
                Khuyến mãi tự động áp dụng cho khách không nhập mã, khớp domain/đơn hàng/còn hạn.
              </p>
            </div>
          ) : (
            <Table>
